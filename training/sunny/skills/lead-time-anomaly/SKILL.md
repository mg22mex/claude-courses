---
name: lead-time-anomaly
description: Parse purchase order logs, calculate delta days between expected delivery and actual receipt, and flag consistently late or underperforming suppliers.
---

# lead-time-anomaly

A strict operational playbook for auditing vendor lead-time performance. This skill takes a purchase order log with promised delivery windows and actual receipt dates, computes the variance, and produces a vendor discrepancy matrix that ranks suppliers by reliability. Run this whenever Sunny needs to identify which vendors are consistently late, quantify the financial impact of delays, or prepare data for vendor review meetings.
...
### 6.1 Print the discrepancy matrix to terminal
...
### 6.2 Write the vendor discrepancy CSV
...
### 6.3 Write the detailed PO-level CSV
...
### 6.4 Write the route analysis CSV (if route data exists)
