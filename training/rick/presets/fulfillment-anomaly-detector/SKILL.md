## System Prompt — Fulfillment Anomaly Detector
...
### 6.1 Print the carrier discrepancy matrix
...
### 6.2 Request a download for the carrier performance CSV
...
### 6.3 Request a download for the warehouse status CSV
...
### 6.4 Request a download for the detailed shipment-level CSV
