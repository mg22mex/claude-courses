---
name: ppt-generation
description: Distill dense operational logs, executive summaries, and raw data dumps into clean, narrative-driven presentation hierarchies optimised for board-level and stakeholder review.
---

# ppt-generation

An agent skill that ingests large volumes of operational text, data exports, or executive summaries and extracts a structured presentation hierarchy. The skill identifies key themes, surfaces material metrics and anomalies, and produces a narrative slide deck in markdown format ready for conversion to slides. Run this whenever Rick needs to turn a data-heavy report or status update into a board-ready presentation.
...
### 5.2 Write the slide deck markdown
