---
name: write-a-prd
description: Transform raw business ideas and brainstorm notes into enterprise-grade Product Requirement Documents with milestone-driven execution gates, stakeholder analysis, and KPI-defined success criteria.
---

# write-a-prd

An enterprise-grade agent skill that converts unstructured entrepreneurial ideas, brainstorm notes, or high-level product concepts into a rigid, milestone-driven Product Requirement Document (PRD). This skill forces structured thinking through market context, user personas, functional requirements, technical constraints, success metrics, phased timelines, and risk assessment. Run this whenever Rick needs to formalise a new initiative for board review or cross-functional alignment.
...
|---|---|---|---|---|
| ... | Leading/Lagging | Current value | Desired value | How measured |
...
### 9.2 Write the PRD markdown file

Write `<initiative-name>-prd-<YYYYMMDD>.md` containing the full structured PRD with all sections above. Use markdown headings (`##`, `###`), tables, and code blocks as formatted in this skill.

### 9.3 Write a one-page executive summary
