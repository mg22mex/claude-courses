...
description: Parse system descriptions, tech stacks, and organisational structures into structured Mermaid architecture diagrams — flowcharts, sequence diagrams, C4 context models, and deployment topology views.
---

# architecture-diagram

A specialised agent skill that translates technical and organisational descriptions into precise, structured architecture diagrams. Given system descriptions, tech stack inventories, organisational charts, or process flows, this skill produces Mermaid diagram code ready for embedding in documentation, PRDs, or slide decks. Run this whenever Rick needs to visualise a system architecture, org structure, data flow, or deployment topology for planning or presentation purposes.
...
### 4.2 Write the Mermaid diagram file
...
### 4.3 Write the architecture description
